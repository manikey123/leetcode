...
myList.index(2)
print("Returns the index of the first occurrence of a specified value - 9 occurs at position 5 using index of 9 .",
    myList.index(9),
...
value = my_dict.get('keyx');
print(value)  # none
value = my_dict.get('keyx', 0);
print(value)  # 0
