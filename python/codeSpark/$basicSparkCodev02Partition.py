...
data = [("James", "Sales", 3000),
        ...
        ("Scott", "Finance", 3300),
        ("Jen", "Finance", 3900),
        ("Thiamine", "Finance", 3000),
        ("Thiamine2", "Finance", 3000),
        ("Thiamine3", "Finance", 3000),
        ("Thiamine4", "Finance", 3000),
        ("Thiamine5", "Finance", 3500),
        ("Thiamine6", "Finance", 3600),
        ("Thiamine7", "Finance", 3800),
        ("Jeff", "Marketing", 3000),
